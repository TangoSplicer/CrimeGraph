...
All required tests must pass. Any failure blocks a production distribution decision unless the release owner records a time-bounded exception, compensating control, risk owner, and remediation commit. Do not accept an exception for a failure of encrypted commissioning, protected media, access control, high-risk confirmation, secure wipe, forensic dossier integrity, lead-promotion traceability, derivative source preservation, saved-query explanation integrity, exhibit custody reauthentication, observation-context integrity, reproducible-briefing digest integrity, or a device assurance report that overstates hardware protection.
